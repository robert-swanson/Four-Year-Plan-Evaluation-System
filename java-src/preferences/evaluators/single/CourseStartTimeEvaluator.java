...
public class CourseStartTimeEvaluator extends SingleCourseOfferingEvaluator {
    ...
    public Result getValue(Context context) {
        ...
        return getValue(context, description, courseOffering -> new ScalableValue.TimeValue(courseOffering.getMeetings().getFirst().getStartTime()));
    }
