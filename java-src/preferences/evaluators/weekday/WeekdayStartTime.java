...
public class WeekdayStartTime extends WeekdayMeetingEvaluator implements ScalableContextEvaluator {

    @Override
    public Result getValue(Context context) {
        return getValue(context, "Weekday Start Time", (meetings, weekday) -> {
            Time start = null;
